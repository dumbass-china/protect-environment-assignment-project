...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{asset('protect-environment')}}/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
        <link href="{{asset('protect-environment')}}/lib/lightbox/css/lightbox.min.css" rel="stylesheet">


        <!-- Customized Bootstrap Stylesheet -->
        <link href="{{asset('protect-environment')}}/css/bootstrap.min.css" rel="stylesheet">

        <!-- Template Stylesheet -->
        <link href="{{asset('protect-environment')}}/css/style.css" rel="stylesheet">
    </head>
    ...
    <body>
       ...
       <!-- Carousel Start -->
                ...
                <div class="row g-4">
                    <div class="col-lg-4">
                        <div class="donation-item">
                            <img src="{{asset('protect-environment')}}/img/donation-1.jpg" class="img-fluid w-100" alt="Image">
                    ...
                    <div class="col-lg-4">
                        <div class="donation-item">
                            <img src="{{asset('protect-environment')}}/img/donation-3.jpg" class="img-fluid w-100" alt="Image">
                            <div class="donation-content d-flex flex-column">
            ...
            <div class="container py-5">
                ...
                <div class="row g-4">
                    <div class="col-lg-6 col-xl-3">
                        <div class="causes-item">
                            <div class="causes-img">
                                <img src="{{asset('protect-environment')}}/img/causes-4.jpg" class="img-fluid w-100" alt="Image">
                    ...
                    <div class="col-lg-6 col-xl-3">
                        <div class="causes-item">
                            <div class="causes-img">
                                <img src="{{asset('protect-environment')}}/img/causes-2.jpg" class="img-fluid w-100" alt="Image">
                                <div class="causes-link pb-2 px-3">
                                    <small class="text-white"><i class="fas fa-chart-bar text-primary me-2"></i>Goal: $3600</small>
                                    <small class="text-white"><i class="fa fa-thumbs-up text-primary me-2"></i>Raised: $4000</small>
                                </div>
                    ...
                    <div class="col-lg-6 col-xl-3">
                        <div class="causes-item">
                            <div class="causes-img">
                                <img src="{{asset('protect-environment')}}/img/causes-3.jpg" class="img-fluid w-100" alt="Image">
                                <div class="causes-link pb-2 px-3">
                                    <small class="text-white"><i class="fas fa-chart-bar text-primary me-2"></i>Goal: $3600</small>
                                    <small class="text-white"><i class="fa fa-thumbs-up text-primary me-2"></i>Raised: $4000</small>
                                </div>
                    ...
                    <div class="col-lg-6 col-xl-3">
                        <div class="causes-item">
                            <div class="causes-img">
                                <img src="{{asset('protect-environment')}}/img/causes-1.jpg" class="img-fluid w-100" alt="Image">
                                <div class="causes-link pb-2 px-3">
                                    <small class="text-white"><i class="fas fa-chart-bar text-primary me-2"></i>Goal: $3600</small>
                                    <small class="text-white"><i class="fa fa-thumbs-up text-primary me-2"></i>Raised: $4000</small>
                                </div>
            ...
            <div class="container py-5">
                ...
                <div class="event-carousel owl-carousel">
                    <div class="event-item">
                        <img src="{{asset('protect-environment')}}/img/events-1.jpg" class="img-fluid w-100" alt="Image">
                    ...
                    <div class="event-item">
                        <img src="{{asset('protect-environment')}}/img/events-2.jpg" class="img-fluid w-100" alt="Image">
                        <div class="event-content p-4">
                            <div class="d-flex justify-content-between mb-4">
                                <span class="text-body"><i class="fas fa-map-marker-alt me-2"></i>Grand Mahal, Dubai 2100.</span>
                                <span class="text-body"><i class="fas fa-calendar-alt me-2"></i>10 Feb, 2023</span>
                    ...
                    <div class="event-item">
                        <img src="{{asset('protect-environment')}}/img/events-3.jpg" class="img-fluid w-100" alt="Image">
                        <div class="event-content p-4">
                            <div class="d-flex justify-content-between mb-4">
                                <span class="text-body"><i class="fas fa-map-marker-alt me-2"></i>Grand Mahal, Dubai 2100.</span>
                                <span class="text-body"><i class="fas fa-calendar-alt me-2"></i>10 Feb, 2023</span>
                    ...
                    <div class="event-item">
                        <img src="{{asset('protect-environment')}}/img/events-4.jpg" class="img-fluid w-100" alt="Image">
                        <div class="event-content p-4">
                            <div class="d-flex justify-content-between mb-4">
                                <span class="text-body"><i class="fas fa-map-marker-alt me-2"></i>Grand Mahal, Dubai 2100.</span>
                                <span class="text-body"><i class="fas fa-calendar-alt me-2"></i>10 Feb, 2023</span>
            ...
            <div class="container py-5">
                ...
                <div class="row g-4">
                    <div class="col-lg-6 col-xl-3">
                        <div class="blog-item">
                            <div class="blog-img">
                                <img src="{{asset('protect-environment')}}/img/blog-1.jpg" class="img-fluid w-100" alt="">
                                <div class="blog-info">
                    ...
                    <div class="col-lg-6 col-xl-3">
                        <div class="blog-item">
                            <div class="blog-img">
                                <img src="{{asset('protect-environment')}}/img/blog-2.jpg" class="img-fluid w-100" alt="">
                                <div class="blog-info">
                                    <span><i class="fa fa-clock"></i> Dec 01.2024</span>
                                    <div class="d-flex">
                                        <span class="me-3"> 3 <i class="fa fa-heart"></i></span>
                    ...
                    <div class="col-lg-6 col-xl-3">
                        <div class="blog-item">
                            <div class="blog-img">
                                <img src="{{asset('protect-environment')}}/img/blog-3.jpg" class="img-fluid w-100" alt="">
                                <div class="blog-info">
                                    <span><i class="fa fa-clock"></i> Dec 01.2024</span>
                                    <div class="d-flex">
                                        <span class="me-3"> 3 <i class="fa fa-heart"></i></span>
                    ...
                    <div class="col-lg-6 col-xl-3">
                        <div class="blog-item">
                            <div class="blog-img">
                                <img src="{{asset('protect-environment')}}/img/blog-4.jpg" class="img-fluid w-100" alt="">
                                <div class="blog-info">
                                    <span><i class="fa fa-clock"></i> Dec 01.2024</span>
                                    <div class="d-flex">
                                        <span class="me-3"> 3 <i class="fa fa-heart"></i></span>
            ...
            <div class="row g-0">
                <div class="col-lg-4">
                    <div class="gallery-item">
                        <img src="{{asset('protect-environment')}}/img/gallery-2.jpg" class="img-fluid w-100" alt="">
                        <div class="search-icon">
                    ...
                    <div class="gallery-item">
                        <img src="{{asset('protect-environment')}}/img/gallery-3.jpg" class="img-fluid w-100" alt="">
                        <div class="search-icon">
                ...
                <div class="col-lg-4">
                    <div class="gallery-item">
                        <img src="{{asset('protect-environment')}}/img/gallery-1.jpg" class="img-fluid w-100" alt="">
                        <div class="search-icon">
                ...
                <div class="col-lg-4">
                    <div class="gallery-item">
                        <img src="{{asset('protect-environment')}}/img/gallery-4.jpg" class="img-fluid w-100" alt="">
                        <div class="search-icon">
                    ...
                    <div class="gallery-item">
                        <img src="{{asset('protect-environment')}}/img/gallery-5.jpg" class="img-fluid w-100" alt="">
                        <div class="search-icon">
                        ...
                        <div class="row g-4">
                            <div class="col-lg-6">
                                <div class="volunteer-img">
                                    <img src="{{asset('protect-environment')}}/img/volunteers-1.jpg" class="img-fluid w-100" alt="Image">
                            ...
                            <div class="col-lg-6">
                                <div class="volunteer-img">
                                    <img src="{{asset('protect-environment')}}/img/volunteers-3.jpg" class="img-fluid w-100" alt="Image">
                                    <div class="volunteer-title">
                                        <h5 class="mb-2 text-white">Michel Brown</h5>
                                        <p class="mb-0 text-white">Communicator</p>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="volunteer-img">
                                    <img src="{{asset('protect-environment')}}/img/volunteers-2.jpg" class="img-fluid w-100" alt="Image">
                                    <div class="volunteer-title">
                                        <h5 class="mb-2 text-white">Michel Brown</h5>
                                        <p class="mb-0 text-white">Communicator</p>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="volunteer-img">
                                    <img src="{{asset('protect-environment')}}/img/volunteers-4.jpg" class="img-fluid w-100" alt="Image">
                                    <div class="volunteer-title">
                                        <h5 class="mb-2 text-white">Michel Brown</h5>
                                        <p class="mb-0 text-white">Communicator</p>
                                    </div>
                            ...
                            <div class="row g-2">
                                <div class="col-4">
                                    <div class="footer-gallery">
                                        <img src="{{asset('protect-environment')}}/img/gallery-footer-1.jpg" class="img-fluid w-100" alt="">
                               ...
                               <div class="col-4">
                                    <div class="footer-gallery">
                                        <img src="{{asset('protect-environment')}}/img/gallery-footer-2.jpg" class="img-fluid w-100" alt="">
                                        <div class="footer-search-icon">
                                ...
                                <div class="col-4">
                                    <div class="footer-gallery">
                                        <img src="{{asset('protect-environment')}}/img/gallery-footer-3.jpg" class="img-fluid w-100" alt="">
                                        <div class="footer-search-icon">
                                ...
                                <div class="col-4">
                                    <div class="footer-gallery">
                                        <img src="{{asset('protect-environment')}}/img/gallery-footer-4.jpg" class="img-fluid w-100" alt="">
                                        <div class="footer-search-icon">
                                ...
                                <div class="col-4">
                                    <div class="footer-gallery">
                                        <img src="{{asset('protect-environment')}}/img/gallery-footer-5.jpg" class="img-fluid w-100" alt="">
                                        <div class="footer-search-icon">
                               ...
                               <div class="col-4">
									<div class="footer-gallery">
										<img src="{{asset('protect-environment')}}/img/gallery-footer-6.jpg" class="img-fluid w-100" alt="">
                                        <div class="footer-search-icon">
        ...
        @include('front-protect-environment.partials.footer')
        <!-- Footer End -->
        ...
        <script src="{{asset('protect-environment')}}/lib/easing/easing.min.js"></script>
        <script src="{{asset('protect-environment')}}/lib/waypoints/waypoints.min.js"></script>
        <script src="{{asset('protect-environment')}}/lib/counterup/counterup.min.js"></script>
        <script src="{{asset('protect-environment')}}/lib/owlcarousel/owl.carousel.min.js"></script>
        <script src="{{asset('protect-environment')}}/lib/lightbox/js/lightbox.min.js"></script>


        <!-- Template Javascript -->
        <script src="{{asset('protect-environment')}}/js/main.js"></script>
