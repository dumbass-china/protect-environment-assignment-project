...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a class="btn btn-primary float-right" href="{{ route('admin.banners.create') }}">create</a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('admin.banners.destroy', $item->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
                                    <a href="{{ route('admin.banners.show', $item->id) }}" class="btn btn-success"><i
                                            class="fa fa-eye"></i> </a>
                                    <a href="{{ route('admin.banners.edit', $item->id) }}" class="btn btn-primary"><i
